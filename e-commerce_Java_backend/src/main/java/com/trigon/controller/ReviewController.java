...
import com.trigon.service.ReviewService;
...
public class ReviewController {
	...
	public ResponseEntity<List<Review>> getProductReview(@PathVariable Long productId) throws UserException,ProductException{
		List<Review> reviewrs=reviewService.getAllReiew(productId);
		return new ResponseEntity<List<Review>>(reviewrs,HttpStatus.CREATED);
	}
}
